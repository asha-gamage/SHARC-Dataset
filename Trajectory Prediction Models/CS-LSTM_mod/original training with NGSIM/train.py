...
# from utils_220323 import ngsimDataset,maskedNLL,maskedMSE,maskedNLLTest
...
def main():
    ...
    f = open('Training Losses.txt', 'w')  # Open a text file to save the calculated RMSE values at each range setting
    ...
    trDataloader = DataLoader(trSet,batch_size=batch_size,shuffle=True,num_workers=1,collate_fn=trSet.collate_fn)# set shuffle to False
    ...
    torch.save(net.state_dict(), 'trained_models/cslstm_no_m_080426.tar')
