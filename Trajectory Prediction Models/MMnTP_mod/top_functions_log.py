...
## Updated the eval_top_func to incorporate saving the resukts in a .pt file on 21/05/26

def eval_top_func(p, model_eval_func, model_kpi_func, model, loss_func_tuple,
                  te_dataset, device, tensorboard=None, save_path=None):
    ...
    # ---------------------------------------------------------
    # Save KPI dictionary as .pt file
    # ---------------------------------------------------------
